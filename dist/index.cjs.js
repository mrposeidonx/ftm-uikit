...
var Nomics = styled__default['default'].a(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  margin: 2%;\n"], ["\n  margin: 2%;\n"])));
var Panel = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu;
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        React__default['default'].createElement(PanelBody, __assign({}, props)),
        React__default['default'].createElement(Nomics, { target: "_blank", rel: "noreferrer", href: "https://rugdoc.io/project/polyvertex/" },
        React__default['default'].createElement("img", { src: "/images/nomics3.png" })),
